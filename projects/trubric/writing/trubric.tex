...
\citet{helm2026query} regress benchmark scores on these representations and prove that the resulting predictions are task-efficient relative to the sample score.
